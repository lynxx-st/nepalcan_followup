...
export default function OrderCollectedByLogistics() {
  ...
  const os = order.orderStatus || order.commerce?.orderStatus || 'Processing';
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="badge-pill bg-purple-600 text-white text-[11px] font-semibold uppercase">Collected by Logistics</span>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
        ...
        <div className="lg:col-span-7 card-blueprint p-4 space-y-3 bg-[#ffffff]">
          <div className="flex items-center justify-between border-b border-[#e5e5e5] pb-2.5">
            ...
            <span className="badge-pill bg-purple-600 text-white font-medium text-[10px]">Collected</span>
          </div>
