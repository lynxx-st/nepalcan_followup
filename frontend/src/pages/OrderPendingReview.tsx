...
export default function OrderPendingReview() {
...
<p className="text-[12px] text-[#737373] mt-0.5 font-medium">
        ...
        <div className="flex items-center gap-2">
          ...
          {vendorPhone !== 'N/A' && (
            <button onClick={() => callPhone(vendorPhone)} className="btn-outline text-xs px-3.5 py-1.5 cursor-pointer min-h-[44px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
        ...
        <div className="lg:col-span-5 card-blueprint p-4 space-y-3 bg-[#ffffff]">
          <div className="flex items-center justify-between border-b border-[#e5e5e5] pb-2.5">
            ...
            <span className="text-xs font-bold text-[#dc3545]">Total: Rs. {computedTotal.toLocaleString()}</span>
          </div>
          ...
          <div className="bg-[#fafafa] p-2.5 rounded-2xl border border-[#e5e5e5] space-y-1 text-[11px]">
            ...
            <div className="flex justify-between text-xs font-bold text-[#0a0a0a] pt-1 border-t border-[#e5e5e5]"><span>Total:</span><span className="text-[#dc3545]">Rs. {computedTotal.toLocaleString()}</span></div>
          </div>
        ...
        <div className="lg:col-span-7 card-blueprint p-4 space-y-3 bg-[#ffffff]">
          <div className="flex items-center justify-between border-b border-[#e5e5e5] pb-2.5">
            <h2 className="text-xs font-bold uppercase tracking-wider text-[#737373] flex items-center gap-1.5">
              ...
              Post-Delivery Review Module
            </h2>
            <span className="badge-pill bg-emerald-600 text-white font-medium text-[10px]">Delivered</span>
          </div>

          <p className="text-xs text-[#737373]">
            Order has been delivered. Call the customer to collect feedback and review.
          </p>

          {/* Logistics Timeline (if shipped) */}
          ...
          <div className="flex flex-wrap items-center gap-2 pt-2">
            ...
            <button
              ...
              className="btn-outline text-xs text-amber-700 border-amber-300 bg-amber-50 px-4 py-2 cursor-pointer flex items-center gap-1.5 font-bold min-h-[44px]"
            >
              ...
              {reviewObj.platformSatisfied && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] pt-1">
                  <div className="p-2 bg-white rounded-xl border border-[#e5e5e5]">
                    ...
                    <span className="font-bold text-[#0a0a0a] uppercase ml-1">{reviewObj.platformSatisfied}</span>
                  ...
                  <div className="p-2 bg-white rounded-xl border border-[#e5e5e5]">
                    ...
                    <span className="font-bold text-[#0a0a0a] uppercase ml-1">{reviewObj.deliverySatisfied}</span>
                  ...
                  <div className="p-2 bg-white rounded-xl border border-[#e5e5e5] sm:col-span-2">
                    ...
                    <span className="font-bold text-[#0a0a0a] uppercase ml-1">{reviewObj.willUseAgain}</span>
